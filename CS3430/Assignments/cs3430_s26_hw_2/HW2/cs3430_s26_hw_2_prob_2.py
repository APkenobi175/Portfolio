...
def sp_avg_rate_of_change(r1: sp.Symbol,
    ...
    """
    v_r2 = sp_laminar_velocity(r2, R, P, eta, l)
    v_r1 = sp_laminar_velocity(r1, R, P, eta, l)
    avg_rate = (v_r2 - v_r1) / (r2 - r1)
    return avg_rate
...
def sp_velocity_gradient(r: sp.Symbol,
    ...
    """
    v = sp_laminar_velocity(r, R, P, eta, l)
    dv_dr = sp.diff(v, r)
    return dv_dr
